            ...
            <div className="container-wrapper p-[1rem] py-[2rem] w-full justify-center flex start ">
                <div className="w-full bg-white  rounded-[24px] max-w-[757px] xl:relative p-[1rem] pt-[2rem] pb-[4rem]">
                    <div className='text-center'>
                        ...
                        <p className='text-[1rem] mt-4 mb-6'>Please check your email for your tickets/grid</p>
                        <Link to="/playerlogin" className="text-[1.4rem] bg-[#00d083] p-2 px-8 rounded-lg text-white hover:bg-[#46e4aa]">My Tickets</Link>
                    </div>
                </div>
            </div>
