...
const Play = () => {
  ...
  return (
    <div className="w-full min-h-full">
      <div className="container-wrappper flex items-start justify-center p-[1rem]">
        <div className="play-card">
          ...
          <div className='flex flex-col w-full sm:flex-row items-center mt-[2rem] gap-[2rem] sm:gap-[1rem]'>
            ...
            <form className="ticket-form w-full p-[2rem] flex flex-col gap-[1rem] rounded-[12px] bg-white">
              ...
              <Link to="/pay" className='text-center px-[1rem] rounded-md py-[.8rem] hover:bg-blue-100 cursor-pointer duration-300 bg-[#85E8C3]'>
                Proceed to payment
              </Link>
